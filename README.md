...
##Required Hardware:
	RPi - in this case, we’ll be using Elliot’s RPi2 and Hamad’s RPi3
	2x Analog Capacitive soil moisture sensors
  2x Solenoid valves 12VDC
  1x Peristaltic pump 12VDC
	1x MCP3008 chip for analog to digital conversion
	1x 5VDC 4-channel relay
